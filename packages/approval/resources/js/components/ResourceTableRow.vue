<template>
    <tr
        ...
        class="group"
        :class="{
            'divide-x divide-gray-100 dark:divide-gray-700':
        ...
        >
            <div class="flex items-center justify-end space-x-0 text-gray-400">
                ...
                <Link
                    ...
                    :as="!resource.approval ? 'button' : 'a'"
                    v-tooltip.click="`Archive`"
                    :aria-label="`Archive`"
                    :dusk="`${resource['id'].value}-archive`"
                    :href="archiveURL"
                    class="inline-flex items-center justify-center h-9 w-9"
                    :class="
                        resource.approval
...
export default {
    ...
    computed: {
        ...
        shouldShowPreviewLink() {
            return (
                this.resource.authorizedToView && this.resource.previewHasFields
            );
        },
        ...
        archiveURL() {
            return this.$url(
                `/resources/${this.resourceName}/${this.resource.id.value}/archive`,
                {
                    viaResource: this.viaResource,
                    viaResourceId: this.viaResourceId,
                    viaRelationship: this.viaRelationship,
