...
namespace Packages\TranslatablePanel;
...
class TranslatablePanel extends MergeValue implements JsonSerializable
{
     ...
     * @var string
     */
    public $component = 'translatable-panel';
    ...
    {
        $this->name = $name;
        $this->withMeta(['locales' => config('translatable.locales_with_label', [])]);
